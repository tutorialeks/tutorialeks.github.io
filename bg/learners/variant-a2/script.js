/**
 * Variant A2: Clean Discount Layout - JavaScript
...
function resizeIframe(iframe) {
    try {
        ...
        console.warn('[Variant A2] Cannot resize iframe (cross-origin):', iframe.src);
    }
}
...
console.log('[Variant A2] Clean Discount Layout initialized');
console.log('[Variant A2] Features: Smooth scroll, fade-in animations, iframe adjustment');
